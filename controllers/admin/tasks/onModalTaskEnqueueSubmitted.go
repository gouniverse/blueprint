...
func (controller *queueManagerController) onModaltaskEnqueueSubmitted(r *http.Request) string {
	...
	if err != nil {
		config.Logger.Error("At adminTasks > onModalTaskEnqueueSubmitted", "error", err.Error())
